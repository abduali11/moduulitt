...
class AsiakasTesti1 {
    public static void main(String[] args) {
        ...
        while (true) {
            System.out.println("(1) lisää Asiakas, (2) poista asiakas tai (3) lopeta");
            ...
            if (toiminto.equals("1")) {
                ...
                if (!asiakasJonossa.isEmpty()) {
                    ...
                    System.out.println("Asiakas poistettu, ID: " + poistettuasiakas.getId());
                    System.out.println("Asiakas oli jonossa: " + kulutettuAika + " nanosekuntia");
                } else {
